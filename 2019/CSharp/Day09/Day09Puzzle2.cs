...
namespace AdventOfCode.CSharp.Year2019.Day09
{
    ...
    Finally, you can lock on to the Ceres distress signal! You just need to boost your sensors
    using the BOOST program.
    ...
    class Day09Puzzle2 : IPuzzle
    {
        ...
        public void Run()
        {
            Console.WriteLine("--- Day 9: Sensor Boost (Part 2) ---");
            ...
            Console.WriteLine($"\t{(outputList.FirstOrDefault() == 80210 ? "CORRECT" : "You did something wrong.")}");
