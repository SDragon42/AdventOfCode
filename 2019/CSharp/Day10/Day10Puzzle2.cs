...
namespace AdventOfCode.CSharp.Year2019.Day10
{
    /*
    --- Part Two ---
    ...
    equipped with a giant rotating laser perfect for vaporizing asteroids. The laser starts by
    pointing up and always rotates clockwise, vaporizing any asteroid it hits.
    ...
    detectable, the newly-detected asteroid won't be vaporized until the laser has returned to
    ...
    chance to be vaporized until the next full rotation. The laser continues rotating; the next
    nine to be vaporized are:
