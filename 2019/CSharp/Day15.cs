...
namespace AdventOfCode.CSharp.Year2019
{
    ...
    public class Day15 : TestBase
    {
        ...
        readonly Stack<Point> stepStack = new Stack<Point>();
        RepairDroid robot;
        ...
        class Map
        {
            private readonly Dictionary<Point, string> mapData = new Dictionary<Point, string>();
            public IDictionary<Point, string> MapData => mapData;

            private readonly Dictionary<Direction, Size> offsets = new Dictionary<Direction, Size>()
        {
            ...
            {
                return GridHelper.DrawPointGrid2D(mapData, minArea: MinArea);
            }
